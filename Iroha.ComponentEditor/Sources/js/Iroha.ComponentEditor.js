...
Iroha.ComponentEditor = {
    ...
    , createComponentDataFromDocumentModel: function(node) {
        ...
        $(node).find('*[data-iroha-component-content]').each(function (i, e) {
            ...
            var content = targetNode.val() || targetNode.text();
...
Iroha.ComponentEditor.UI = {
    ...
    , setup: function (config) {
        ...
        this.componentEditorNode.delegate('span[data-iroha-component-content]', 'click', function (e){
            var currentTarget = $(this);
            var value = currentTarget.val() || currentTarget.text();
            var newNode = $('<input type="text" value="" data-iroha-component-content="" />')
                                .val(value).text(value)
                                .data('iroha-component-content', currentTarget.data('iroha-component-content'))
                                .attr('data-iroha-component-content', currentTarget.data('iroha-component-content'))
                                .blur(function (e) {
                                    var currentTarget = $(this);
                                    var value = currentTarget.val() || currentTarget.text();
                                    var newNode = $('<span data-iroha-component-content="" />')
                                                        .text(value)
                                                        .data('iroha-component-content', currentTarget.data('iroha-component-content'))
                                                        .attr('data-iroha-component-content', currentTarget.data('iroha-component-content'))
                                                    ;
    ...
    , addComponent: function(id, parentComponent) {
        ...
        // TODO: sortable にする位置 (componentFrame共通化?)
        if ((component.type == "Container" || component.type == "Children"))
        ...
        function addComponentFromContentData(contentData, parentComponent) {
            contentData.forEach(function (content, i) {
                ...
                content.data.forEach(function (data, j) {
                    createdComponentFrame.find('[data-iroha-component-content='+data.id+']').text(data.content).val(data.content);
                });
